<main class="my-5 mx-2 h-auto ">
        <div class="container h-auto mx-auto px-6">
            ...
            <form class="flex w-full m-0 items-center justify-center text-center" action="{{url('products')}}">
                <input class="font-semibold rounded shadow-md cursor-pointer w-full mx-2 mt-2  bg-red-500 hover:bg-red-600  p-2 text-white text-center" type="button" value="Verwijder">            </form>
        </div>
            @endforeach
